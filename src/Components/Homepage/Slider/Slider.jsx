...
const Button = styled.button`
  ...
  box-shadow: rgba(0, 0, 0, 0.15) 0px 15px 25px, rgba(0, 0, 0, 0.344) 0px 5px 10px;
  margin: 3vh;
    ...
    <Container>
          ...
          <Slide bg={item.bg} key={item.id}>
            <InfoContainer>
              ...
              <Desc>Lorem ipsum dolor sit amet consectetur, 
                adipisicing elit. Repudiandae aspernatur dolorem dolores! Tenetur inventore,
                 sit eligendi, ea dicta totam quas autem illum, cumque obcaecati 
      ...
      <Indicators>
        {Items.map((image, index) => (
          <Indicator key={index} isActive={index === selectedValue} onClick={() => handleClickOne(index)} />
        ))}
      </Indicators>
