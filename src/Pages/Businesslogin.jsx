import { DownloadDone, Login, ReceiptLong, RequestQuote } from '@mui/icons-material'
...
import BusiLog from '../Components/BusinessLogin/BusiLog'
      ...
      <Midcon>
        ...
        <Instruc>
          <Avatar sx={{'&:hover':{background:"#FF9471"},background:"white" , padding:"2.5vh", marginRight:"3vh"}}>
            <RequestQuote  sx={{height:"4vh",width:"4vh", borderWidth:"1vh",color:"black",padding:"2vh", background:"white", borderRadius:"50%"}} /></Avatar>
          <InsDis>Request quotes
          <InsDisSpan>Request quotes by clicking “Place Bulk Order” button on Products Menu.</InsDisSpan>
          </InsDis>
        ...
        <Instruc>
          ...
          <InsDis>Receive quotes
          <InsDisSpan>You will receive a quote within 24 hours of placing the order.</InsDisSpan>
          </InsDis>
        ...
        <Instruc>
          <Avatar sx={{'&:hover':{background:"#FF9471"},background:"white" , padding:"2.5vh", marginRight:"3vh"}}>
            <DownloadDone  sx={{height:"4vh",width:"4vh", borderWidth:"1vh",color:"black",padding:"2vh", background:"white", borderRadius:"50%"}} /></Avatar>
          <InsDis>Finalise
          <InsDisSpan>After receiving the quote, finalise order and get it delivered at your doorstep.</InsDisSpan>
          </InsDis>
